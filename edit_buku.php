  ...
  if (isset($_GET['id'])) {
    ...
    $data = mysqli_fetch_assoc($result);
      // apabila data tidak ada pada database maka akan dijalankan perintah ini
       if (!count($data)) {
          echo "<script>alert('datanya gada di database gan');window.location='index.php';</script>";
       }
  } else {
  ...
  <body>
      ...
      <section class="base">
        ...
        <div >
          ...
          <i style="float: left;font-size: 11px;color: #D1F2EB">Abaikan jika tidak merubah gambar produk...!</i>
        </div>
        <div>
